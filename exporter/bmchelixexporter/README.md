...
This exporter supports sending metrics to [BMC Helix Operations Management](https://www.helixops.ai/products/bmc-helix-operations-management.html) through its [metric ingestion REST API](https://docs.bmc.com/docs/helixoperationsmanagement/244/en/metric-operation-management-endpoints-in-the-rest-api-1392780044.html).
